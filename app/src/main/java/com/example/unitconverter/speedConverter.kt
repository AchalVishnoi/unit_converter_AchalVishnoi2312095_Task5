...
class speedConverter : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    var weight = arrayOf<String?>("Meter per sec",
        "Kilometer per hr","Foot per sec"
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spinner1=findViewById(R.id.spsp1)
        spinner2=findViewById(R.id.spsp2)
        ep1=findViewById(R.id.uppersp)
        ep2=findViewById(R.id.Lowersp)
        ...
        var b1: ImageButton =findViewById(R.id.back5);

        title = "KotlinApp"

        b1.setOnClickListener {
            val intent = Intent(this@speedConverter, MainActivity2::class.java)
